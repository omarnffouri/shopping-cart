        ...
        <div class="product-detail checkout-detail">
            <div class="detail-left p-20 p-sm-15 pb-10 area mr-20 mr-sm mb-sm-15 ">
                ...
                <div class="flex align-start gap-15 start">
                    ...
                    <form class="address-form" @submit.prevent="savingAddressData">
                        <pop-over v-if="addressPopup" :title="$t('filter.address')" @close="closeAddressPopup"
                                  elem-id="shipping-address-pop-over" :layer="true">
...
const {location, setting, site_setting} = storeToRefs(commonStore)
const { setToastError, unAuthGet} = commonStore
