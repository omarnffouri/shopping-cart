<template>
    <div class="mt-20 pb-30 pb-sm-20">
        ...
        <sitemap v-if="isSitemap" :page-title="pageTitle" :page="page"/>

        <component v-else-if="isPageFromComponent" :page-title="pageTitle" :is="currentComponent"/>

        <div v-else class="mtb-20 mtb-sm-15 html-render">
            <div class="container">
