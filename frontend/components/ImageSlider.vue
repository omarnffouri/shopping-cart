<template>
    <div class="embla glide slider-wrapper" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave">
    ...
    const startAutoplay = () => {
        if (autoplay.value > 0) {
            ...
            interval.value = setInterval(() => {
                if (emblaApi.value && emblaApi.value.canScrollNext()) {
                    emblaApi.value.scrollNext();
                } else if (emblaApi.value && loop.value) {
