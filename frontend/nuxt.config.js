...
export default defineNuxtConfig({
  ...
  app: {
    head: {
      ...
      script: [
        ...(googleAdsId
            ? [
              {src: `https://www.googletagmanager.com/gtag/js?id=${googleAdsId}`, async: true},
              {
                hid: 'google-ads-gtag-base',
                innerHTML: `
  ...
  pwa: {
    ...
    workbox: {
      // Remove precaching — SSR pages are dynamic
      navigateFallback: null, // or leave it null
      runtimeCaching: [
        {
          urlPattern: '.*', // catch-all
