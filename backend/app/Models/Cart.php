...
class Cart extends Model
{
    ...
    protected $fillable = [
        ...
        'shipping_place_id', 'shipping_type', 'user_token', 'admin_id',
        'user_delivery_type_id'
    ];
    ...
    public function userDeliveryType(): \Illuminate\Database\Eloquent\Relations\BelongsTo
    {
    ...
    {
        return $this->hasOne(CartProductNote::class, 'cart_id');
    }
}
