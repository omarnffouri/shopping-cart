...
class PayFast
{
    ...
    public static function pfValidSignature( $pfData, $pfParamString, $pfPassphrase = null ): bool
    {
    ...
    public static function pfValidIP(): bool
    {
    ...
    public static function pfValidPaymentData( $cartTotal, $pfData ): bool
    {
        return !(abs((float)$cartTotal - (float)$pfData['amount_gross']) > 0.01);
    }

    public static function pfValidServerConfirmation( $pfParamString, $pfHost = 'sandbox.payfast.co.za', $pfProxy = null ): bool
    {
    ...
    public static function getPayFastForm( $payment, $order, $re, $price ): string
    {
        $data = array(
            // Merchant details
