...
class InventoriesController extends ControllerHelper
{
    ...
    public function action(Request $request)
    {
        ...
        if(isset($request['quantity'])){
            ...
            foreach (request('attributes') as $item){
                ...
                $attributesFromRequest[] = $item['attributes'];
                $responseObj[] = $item;
