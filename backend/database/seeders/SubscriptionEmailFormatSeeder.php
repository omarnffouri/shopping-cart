        ...
        $items = [
            [
                ...
                'body' => '<div style="padding: 30px 0;"><h4>Free shipping for you</h4>
                        ...
                        <a style="background: #4380F3; padding: 15px 30px; color:#ffffff; text-decoration:none;" href="https://givvo.com/all-products/products" target="_blank">CLAIM SHIPPING FREE PRODUCTS</a>
                        </div>'
            ]
        ];
