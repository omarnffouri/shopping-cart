...
use App\Http\Controllers\DeliveryTypeStateController;
use App\Http\Controllers\OrderSettingsController;
use App\Http\Controllers\UserDeliveryTypeController;
...
//Route::post('/webhook/receive-inventory-update', function () {
//    Log::info('🔔 Route hit!');
...
//
//    $html = View::make('mail_templates.order_pdf', $mailDataLang)->render();
//    $mpdf->WriteHTML($html);
//
//
//    return View::make('mail_templates.order_pdf', $mailData)
//        ->render();
//
...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::group(['middleware' => ['auth:admin', 'scope:admin']], function () {
        ...
        Route::group(['prefix' => 'order-setting'], function () {
            Route::get('find', [OrderSettingsController::class, 'find']);
            Route::post('action', [OrderSettingsController::class, 'action']);
        });
        ...
        Route::group(['prefix' => 'product-image-attributes'], function () {
        ...
        Route::group(['prefix' => 'updated-inventory'], function () {
        ...
        Route::group(['prefix' => 'pos-setting'], function () {
        ...
        Route::group(['prefix' => 'pos-order'], function () {
        ...
        Route::group(['prefix' => 'withdrawal-account'], function () {
        ...
        Route::group(['prefix' => 'subscription-email-format'], function () {
        ...
        Route::group(['prefix' => 'footer-link'], function () {
        ...
        Route::group(['prefix' => 'home-slider-image'], function () {
        ...
        Route::group(['prefix' => 'site-feature'], function () {
        ...
        Route::group(['prefix' => 'tax-rule'], function () {
        ...
        Route::group(['prefix' => 'bundle-deal'], function () {
        ...
        Route::group(['prefix' => 'shipping-rule'], function () {
        ...
        Route::group(['prefix' => 'wysiwyg-image'], function () {
        ...
        Route::group(['prefix' => 'page-wysiwyg-image'], function () {
        ...
        Route::group(['prefix' => 'feature-wysiwyg-image'], function () {
        ...
        Route::group(['prefix' => 'custom-script'], function () {
        ...
        Route::group(['prefix' => 'order'], function () {
            ...
            Route::get('abended', [OrdersController::class, 'abended']);
        ...
        Route::get('delivery-types/show/{state}', [DeliveryTypeController::class, 'getDeliveryTypeByState']);
        Route::resource('admin-delivery-types', DeliveryTypeController::class)->except('show', 'create');
        Route::resource('time-slots', TimeSlotController::class)->only('update', 'destroy');
    });
});
...
Route::group(['prefix' => 'v1'], function () {
    ...
    Route::get('addons', [FrontendController::class, 'addons']);
    ...
    Route::group(['prefix' => 'order'], function () {
        ...
        Route::post('expiring-soon', [OrdersController::class, 'expiringSoon']);
    });

    Route::post('payment/telr/create', [OrdersController::class, "createTelrPaymentRef"]);
    Route::post('payment/telr/update', [OrdersController::class, "telrPaymentUpdate"]);
    ...
    Route::group(['prefix' => 'user'], function () {
        ...
        Route::group(['prefix' => 'social-login', 'middleware' => ['social', 'web']], function () {
        ...
        Route::group(['middleware' => ['auth:user', 'scope:user']], function () {
            ...
            Route::group(['prefix' => 'compare-list'], function () {
    ...
    Route::get('get-user-delivery-type', [UserDeliveryTypeController::class, "getUserDeliveryTypeByUserId"]);
    Route::get('state-delivery-types', DeliveryTypeStateController::class);
    Route::resource('delivery-types', UserDeliveryTypeController::class)->only('index', 'store', 'update', 'destroy');
});
