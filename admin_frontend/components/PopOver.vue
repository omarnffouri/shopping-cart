<template>
  ...
  >
    <div
      class="pop-layer"
      @click.prevent="outsideClickFn"
    />
    <div
      class="pop-over-inner"
      :id="elemId"
      v-bind="dynamicDirectives"
    ...
    >
      ...
      >
        ...
        <button
          ...
          @click.prevent="closePopOver($event)"
        >
          <i
      ...
      <div class="pop-over-content p-15 p-xs-10 sb">
        <slot
          name="content"
        />
      </div>
  ...
  export default {
    ...
    mounted() {
      ...
      if (this.hasLayer) {
        ...
        this.dynamicDirectives = {

          'v-outside-click': this.outsideClickFn,
        };
      }
    },
    destroyed() {
